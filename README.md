...
1. [setup.md](setup.md) をダウンロードする（バージョン固定を推奨）
   ...
   **macOS / Linux**
   ...
   ```bash
   curl -fLO https://raw.githubusercontent.com/i8ei/claude-obsidian-setup/v1.2.1/setup.md
   ```

   **Windows (PowerShell)**

   ```powershell
   Invoke-WebRequest -Uri "https://raw.githubusercontent.com/i8ei/claude-obsidian-setup/v1.2.1/setup.md" -OutFile "setup.md"
   ```
...
| Agent Skills | Obsidian CEO Steph Ango（kepano）が公開したthird-party Agent Skills、[kepano/obsidian-skills](https://github.com/kepano/obsidian-skills)を確認済みcommitから導入 |
