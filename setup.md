...
ノートが100枚を超えた頃、または高速全文検索（SQLite FTS5、0秒・2文字対応）、［要確認］の棚卸し、既存資料の取り込みが必要になった場合、追加パッケージ [addons/vault-search](addons/vault-search/README.md) を案内する。最初からは導入しない。
